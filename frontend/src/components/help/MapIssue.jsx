...
const mapIssues = [
  "Report a problem in the Uber map",
  "Fix a business or landmark issue on Uber Maps",
  "Fix an incorrect address on Uber Maps",
...
const MapIssue = () => {
  return (
    <div className="bg-black min-h-screen pl-32 text-white px-16 py-12">
