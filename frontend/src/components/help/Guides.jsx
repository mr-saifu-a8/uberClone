...
const guideTopics = [
  ...
  "Delegate profiles FAQ",
  "Brand Health Tracker questions",
  "Uber Intercity FAQs",
  "Book an Uber ride through the Expedia Integration feature",
  "About India Customer support",
  "Frequently Asked Questions",
  "Careers",
  "UberPet - A ride for all paws",
];

const Guides = () => {
  return (
    <div className="bg-black min-h-screen text-white px-16 py-12">
